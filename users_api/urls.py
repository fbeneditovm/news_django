...
from .views import ClientUserCreateView, UserManagementView, EmailTokenObtainPairView, UserCollectionView  # Add this import
...
urlpatterns = [
    ...
    path(
        "users/", UserCollectionView.as_view(), name="user_management"
    ),  
    path(
